...
namespace Publisher_Data_Operations.Helper
{
    ...
    public class Pivot
    {
        ...
        public DataTable PivotData(string RowField, string DataField, AggregateFunction Aggregate, params string[] ColumnFields)
        {
            ...
            {
                dt.Columns.Add(col.Name.ToString());  // Creates the result columns.//
            }
        ...
        /// <summary>
        /// Retrieves the data for matching RowField value and ColumnFields values with Aggregate function applied on them.
        /// </summary>
